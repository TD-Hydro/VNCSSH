...
class SettingFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.radioBuiltInTTY = wx.RadioButton(self.notebook_1_Terminal, wx.ID_ANY, _(u"Built-in Terminal"))
        self.radioPowerShell = wx.RadioButton(self.notebook_1_Terminal, wx.ID_ANY, _(u"PowerShell (Recommended)"))
    ...
    def __do_layout(self):
        ...
        self.notebook_1.AddPage(self.notebook_1_Terminal, _(u"Terminal"))
